...
text(x(:),y(:),textStrings(:),'HorizontalAlignment','center', 'fontsize', 18, 'fontweight', 'bold', 'fontname', 'Consolas');
title([FILE_NAME ' ' CONFUSION_MATRIX_NAME ;'\eta=' num2str(LEARNING_RATE) ', \alpha=' num2str(MOMENTUM) ', #hNodes=' numHiddenNodesForString; 'fold=' num2str(k) ', #generation=' num2str(generation) ; ' accuracy=' num2str(accuracy)]);
text(x(:),y(:),textStrings(:),'HorizontalAlignment','center', 'fontsize', 18, 'fontweight', 'bold', 'fontname', 'Consolas');
hold off;
